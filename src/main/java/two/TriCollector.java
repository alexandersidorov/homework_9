...
public class TriCollector<T, A, R> implements Collector<T, A, R> {
    ...
    TriCollector(Supplier<A> supplier,
    ...
    public static <T, R1, R2, R3, R> Collector<T, ?, R> tripling(Collector<? super T, ?, R1> downstream1,
        ...
        return tripling0(downstream1, downstream2, downstream3, merger);
    }


    private static <T, A1, A2, A3, R1, R2, R3, R> Collector<T, ?, R> tripling0(Collector<? super T, A1, R1> downstream1,
        ...
        if (CH_ID.containsAll(c1Characteristics) || CH_ID.containsAll(c2Characteristics) || CH_ID.containsAll(c3Characteristics)) {
            ...
            EnumSet<Characteristics> c = EnumSet.noneOf(Collector.Characteristics.class);
        ...
        return new TriCollector<>(TriBox::new, TriBox::add, TriBox::combine, TriBox::get, characteristics);
    }
